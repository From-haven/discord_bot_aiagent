...
# Token đọc từ biến môi trường DISCORD_TOKEN
...
# Cho phép override một số giá trị bằng biến môi trường
...
START_DATE = datetime.datetime.strptime(config.get("start_date", "2026-06-15"), "%Y-%m-%d").date()
START_WEEK = config.get("start_week", 1)
